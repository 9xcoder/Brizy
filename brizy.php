...
{{ brizy_dc_filter
    ...
    By post field post_title <input type="text" name="{{brizy_dc_option_name}}"  value="{{brizy_dc_option_value}}"> ({{brizy_dc_option_count}})
{{ end_brizy_dc_filter }}
<hr>
{{ brizy_dc_filter
	type="radio"
...
{{ brizy_dc_filter
    ...
    <input type="checkbox" name="{{brizy_dc_option_name}}" id="gg{{brizy_dc_option_index}}"    value="{{brizy_dc_option_value}}" {{brizy_dc_option_checked}}/>
    <label for="gg{{brizy_dc_option_index}}">{{brizy_dc_option_label}} ({{brizy_dc_option_count}})</label><br>  
{{ end_brizy_dc_filter }}
<hr>
{{ brizy_dc_filter
	type="checkbox"
    ...
    <input type="checkbox" name="{{brizy_dc_option_name}}" id="jj{{brizy_dc_option_index}}" value="{{brizy_dc_option_value}}" {{brizy_dc_option_checked}}/>
    <label for="jj{{brizy_dc_option_index}}">{{brizy_dc_option_label}} ({{brizy_dc_option_count}})</label><br>  
{{ end_brizy_dc_filter }}
